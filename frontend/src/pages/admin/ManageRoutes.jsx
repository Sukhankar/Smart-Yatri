      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
            ...
            className="bg-gradient-to-r from-red-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:from-red-700 hover:to-pink-700 transition-all duration-200 shadow-lg font-semibold"
          >
            + Add Route
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
          {routes.length === 0 && (
            <div className="col-span-full text-center py-12">
              ...
              <button
                onClick={handleCreate}
                className="bg-gradient-to-r from-red-600 to-pink-600 text-white px-8 py-3 rounded-xl hover:from-red-700 hover:to-pink-700 transition-all duration-200 font-semibold shadow-lg"
              >
                Create First Route
              </button>
            </div>
            ...
            >
              ...
              <div className="flex gap-2 pt-3">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-red-600 to-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-red-700 hover:to-pink-700 transition-all shadow"
                >
                  Edit
                </button>
                <button
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 relative">
              <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-red-700 to-pink-600 bg-clip-text text-transparent">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-gradient-to-r from-red-600 to-pink-600 text-white px-4 py-2 rounded-xl hover:from-red-700 hover:to-pink-700 transition-all font-semibold shadow"
                  >
