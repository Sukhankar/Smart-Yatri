                  ...
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-red-50/30 transition">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold 
                          ${user.loginType === 'STUDENT' ? 'bg-blue-100 text-blue-800'
                            ...
                            : user.loginType === 'ADMIN' ? 'bg-red-100 text-red-800'
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          onClick={() => setSelectedUser(user)}
                          className="bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl px-4 py-2 shadow hover:from-red-600 hover:to-pink-600 transition-all duration-200 font-semibold"
                        >
                          View Details
                        </button>
                      </td>
                  ...
                  <div>
                    ...
                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold 
                      ${selectedUser.loginType === 'STUDENT' ? 'bg-blue-100 text-blue-800'
                        ...
                        : selectedUser.loginType === 'ADMIN' ? 'bg-red-100 text-red-800'
                        : 'bg-gray-100 text-gray-700'}`
                    }>
