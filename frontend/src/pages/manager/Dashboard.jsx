...
export default function ManagerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-gray-50 flex">
      <Sidebar role="manager" />
      <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <button
            onClick={() => navigate('/manager/verify-payment')}
              ...
              {pendingPasses.slice(0, 5).map((pass) => (
                <div key={pass.id} className="border-l-4 border-yellow-500 bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-xl hover:shadow-md transition-all duration-200">
                  <div className="flex justify-between items-start">
                    ...
                    <button
                      onClick={() => navigate(`/manager/approve-passes`)}
                      className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-blue-800 transition text-sm font-semibold shadow-md"
                    >
                      Review
                    </button>
                  </div>
