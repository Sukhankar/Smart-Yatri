          ...
          {tickets.length === 0 && (
            <div className="bg-white/80 rounded-2xl shadow-xl border border-gray-200/50 p-12 text-center mt-10">
              ...
              <button
                ...
                className="mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-3 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg font-semibold"
              >
                Buy a Ticket
              </button>
            </div>
